...
import MeatingHome from "./components/meeting/MeatingHome";
      ...
      <div className="w-4/5 mx-auto my-10">
        <div className="grid md:grid-cols-4 sm:grid-cols-1 gap-5">
          <div className="rounded-md border-red-100 border-2 bg-white">
            ...
            <div className="m-2">
              <h3 class="text-xl font-bold mb-2 text-center text-indigo-600">
                Web Development
              </h3>
            </div>
            <div className="m-2">
            ...
            <div className="text-center py-2">
              <a
                href="#_"
                class="relative inline-flex items-center justify-start py-1 pl-4 pr-12 overflow-hidden font-semibold text-indigo-600 transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-gray-50 group"
              >
                <span class="absolute bottom-0 left-0 w-full h-1 transition-all duration-150 ease-in-out bg-indigo-600 group-hover:h-full"></span>
                <span class="absolute right-0 pr-4 duration-200 ease-out group-hover:translate-x-12">
                  <svg
