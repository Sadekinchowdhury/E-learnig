    ...
    return (
        <>
            ...
            <section className='lg:px-[200px] px-4 md:px-8 py-16 bg-gray-100'>
                ...
                <p className='lg:w-4/5'>MIT is renowned for its strong emphasis on innovation, interdisciplinary collaboration, and hands-on learning. It offers undergraduate and graduate programs in fields such as engineering, science, architecture, business, economics, computer science, and social sciences. The university's academic departments are organized into five schools: Architecture and Planning, Engineering, Humanities, Arts, and Social Sciences, Management, and Science.</p>
