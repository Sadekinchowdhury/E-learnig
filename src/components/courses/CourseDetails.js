                ...
                <div className="grid lg:grid-cols-2 grid-cols-1 gap-8 w-4/5 mx-auto lg:my-5">
                    <div className="flex flex-col justify-center">
                        ...
                        <div className="flex lg:gap-3 md:gap-2 gap-1 lg:py-12 md:py-8 py-5">
                            ...
                            <p className="flex items-center lg:text-lg md:text-lg text-sm gap-1">
                                <BsClockFill className="text-[#ffe800]"/>
                                3 months
                            </p>
                        </div>
                    ...
                    <div className="">
                        <img className="w-full" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSM_HbOix0HF9SRXTPJCel_5OdIp7NqyRF8fIT1aFES3LX40PkYbZPd6x0AJrxED1KF9AA&usqp=CAU"/>
                    </div>
                </div>
            </section>
