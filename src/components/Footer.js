              ...
              <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="">
                  ...
                  <p class="mb-1">
                    <Link
                      to="/speaking"
                      class="text-slate-100 dark:text-neutral-200"
                    >
                      Speaking
                    </Link>
                  </p>
                  ...
                  <p class="mb-1">
                    <Link
                      to="/digitalMarketing"
                      class="text-neuslatetral-100 dark:text-neutral-200"
                    >
                      Digital Markeing
                    </Link>
                  </p>
            ...
            <div class="grid md:grid-cols-2 sm:grid-cols-1 items-center justify-center pt-1 pb-2 p-6 lg:justify-between">
              ...
              <div class="flex justify-center">
                <a
                  ...
                  class="mr-6 text-slate-100 dark:text-slate-100"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-4 w-4"
                ...
                <a
                  ...
                  class="mr-6 text-slate-100 dark:text-neutral-200"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-4 w-4"
