...
import VisaCard from '../assects/images/visa.png'
import MasterCard from '../assects/images/master-card.png'
import BankTransfer from '../assects/images/bank-transfer.png'
import Nagad from '../assects/images/nagad.webp'
                ...
                <footer class="bg-slate-700 text-center text-slate-100 dark:bg-slate-700 dark:text-slate-100 lg:text-left">
                    <div class="mx-6 py-5 text-center md:text-left border-b-2 border-neutral-200 p-6 dark:border-neutral-500">
                        <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                            <div class="">
                                <h6 class="mb-1 flex items-center justify-center font-semibold uppercase md:justify-start">
                                    <img src={USA}
                                        ...
                                        alt='visa card'/>
                                    <p className='text-xl ml-2'>USA</p>
                                </h6>
                            ...
                            {/* Courses */}
                            <div class="">
                                <h6 class="mb-1 flex text-xl justify-center font-semibold uppercase md:justify-start">
                                    Courses
                                </h6>
                                <p class="mb-1">
                                    <a href="#!" class="text-slate-100 dark:text-neutral-200">Speaking</a>
                                </p>
                                <p class="mb-1">
                                    <a href="#!" class="text-slate-100 dark:text-neutral-200">Freelancing</a>
                                </p>
                                <p class="mb-1">
                                    <a href="#!" class="text-neuslatetral-100 dark:text-neutral-200">Digital Markeing</a>
                                </p>
                                <p>
                                    <a href="#!" class="text-slate-100 dark:text-neutral-200">Web Development</a>
                                </p>
                            </div>
                            <div class="">
                                <h6 class="mb-1 flex text-xl justify-center font-semibold uppercase md:justify-start">
                        ...
                        <div className="w-full bg-slate-700 mx-auto pt-5">
                            <div className="w-4/5 bg-slate-700 mx-auto">
                                <footer class="bg-slate-700 text-center text-slate-100 dark:bg-slate-700 dark:text-slate-100 lg:text-left">
                                    <div class="mx-6 py-5 text-center md:text-left border-b-2 border-neutral-200 p-6 dark:border-neutral-500">
                                        <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                                            ...
                                            <div class="">
                                                ...
                                                <p class="mb-1">
                                                    <Link to="/speaking" class="text-slate-100 dark:text-neutral-200">
                                                        Speaking
                                                    </Link>
                                                </p>
                                                <p class="mb-1">
                                                    <Link to="/freelancing" class="text-slate-100 dark:text-neutral-200">
                                                        Freelancing
                                                    </Link>
                                                </p>
                                                <p class="mb-1">
                                                    <Link to="/digitalMarketing" class="text-neuslatetral-100 dark:text-neutral-200">
                                                        Digital Markeing
                                                    </Link>
                                                </p>
                                                <p>
                                                    <Link to="/webDevelopment" class="text-slate-100 dark:text-neutral-200">
                                                        Web Development
                                                    </Link>
                                                </p>
                                            </div>
                                            <div class="">
                                                ...
                                                <p class="mb-1">
                                                    <Link to="#!" class="text-slate-100 dark:text-neutral-200">
                                                        Help
                                                    </Link>
                                                </p>
                                                <p class="mb-1">
                                    ...
                                    >>>>>>> b98eed99c09d9a1a88625889e3c164a19a1643a2 {/* Money Transfer */}
                                ...
                                <span>Get connected with us on social networks:</span>
                                        ...
                                        <div class="flex justify-center">
                                            ...
                                            <a href="https://www.youtube.com/" class="mr-6 text-slate-100 dark:text-slate-100">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="currentColor" viewBox="0 0 576 512">
                                            ...
                                            <a href="https://www.google.com/" class="mr-6 text-slate-100 dark:text-neutral-200">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                                                    <path d="M7 11v2.4h3.97c-.16 1.029-1.2 3.02-3.97 3.02-2.39 0-4.34-1.979-4.34-4.42 0-2.44 1.95-4.42 4.34-4.42 1.36 0 2.27.58 2.79 1.08l1.9-1.83c-1.22-1.14-2.8-1.83-4.69-1.83-3.87 0-7 3.13-7 7s3.13 7 7 7c4.04 0 6.721-2.84 6.721-6.84 0-.46-.051-.81-.111-1.16h-6.61zm0 0 17 2h-3v3h-2v-3h-3v-2h3v-3h2v3h3v2z" fill-rule="evenodd" clip-rule="evenodd"/>
                                                </svg>
                                            </a>
                                            <a href="https://www.instagram.com/" class="mr-6 text-slate-100 dark:text-neutral-200">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <a href="https://linkedin.com/" class="mr-6 text-slate-100 dark:text-neutral-200">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                                                    <path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z"/>
                                                </svg>
                                            </a>
                                            <a href="https://github.com/" class="text-slate-100 dark:text-neutral-200">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div class="flex justify-center mt-5 pb-2">
                                        <p>
                                            © copy riht 2023 e-learning. All rights reserved Developed by
                                                            Online Team
                                        </p>
                                    </div>
                                </footer>
