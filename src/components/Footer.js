...
export default function Footer() {
    return (
        <div>
            <div className='w-screen bg-slate-700 mx-auto'>
                    ...
                    <footer class="bg-slate-700 text-center text-slate-100 dark:bg-slate-700 dark:text-slate-100 lg:text-left">
                        <div class="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-neutral-500 lg:justify-between">
                            ...
                            <div class="flex justify-center">
                                <a href="#!" class="mr-6 text-slate-100 dark:text-slate-100">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/>
                                    </svg>
                                </a>
                                <a href="#!" class="mr-6 text-slate-100 dark:text-neutral-200">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mx-6 py-10 text-center md:text-left">
                            <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                                ...
                                <div class="">
                                    ...
                                    <p class="mb-4">
                                        <a href="#!" class="text-slate-100 dark:text-neutral-200">Angular</a>
                                    </p>
                                    <p class="mb-4">
                                        <a href="#!" class="text-slate-100 dark:text-neutral-200">React</a>
                                    </p>
                                    <p class="mb-4">
                                        <a href="#!" class="text-neuslatetral-100 dark:text-neutral-200">Vue</a>
                                    </p>
                                    <p>
                                        <a href="#!" class="text-slate-100 dark:text-neutral-200">Laravel</a>
                                    </p>
                                </div>
                                <div class="">
                                    <h6 class="mb-4 flex justify-center font-semibold uppercase md:justify-start">
                                    ...
                                    <p class="mb-4">
                                        <a href="#!" class="text-slate-100 dark:text-neutral-200">Pricing</a>
                                    </p>
                                    <p class="mb-4">
                                        <a href="#!" class="text-slate-100 dark:text-neutral-200">Settings</a>
                                    </p>
                                    <p class="mb-4">
                                        <a href="#!" class="text-slate-100 dark:text-neutral-200">Orders</a>
                                    </p>
                                    <p>
