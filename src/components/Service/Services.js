                ...
                <div className="container  py-4">
                    <div className="grid py-4  grid-cols-1 gap-7  w-11/12 mx-auto sm:grid-cols-2 md:grid-cols-3  lg:grid-cols-4">
                        {cards.map((card, index) => (
                            <Link to={card.path} className='text-white text-left  bg-gradient-to-b  transition duration-200 hover:scale-110 cursor-pointer hover:border-[1px] hover:border-blue-400  border-[0.01px] border-gray-700 rounded-xl shadow-2xl p-8 flex-col  items-center justify-center'>
                    ...
                    <div className='py-20 flex items-center justify-center'>
                        <Link to="/service" className='py-3 px-7 hover:border-[2px] border-[2px] border-blue-400 text-white bg-blue-900 text-xl font-semibold rounded-full'>Get Started</Link>
                    </div>
                </div>
            </div>
