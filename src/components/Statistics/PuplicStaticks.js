...
const PublicStaticks = () => {
    ...
    return (
        <div className='bg-black  py-16   bg-gradient-to-t'>
            ...
            <div className='grid w-11/12 mx-auto grid-cols-1 md:grid-cols-2'>
                <div className='py-10 flex items-center justify-center w-4/5 mx-auto text-white'>
                    <div>
                        <h1 className='text-4xl text-white font-medium text-left'>Privete Courses</h1>
                ...
                <div className="grid  gap-7  w-11/12 mx-auto grid-cols-1 md:grid-cols-2">
                    {
                    statistics.map((statics, index) => (
                        <Link className={`text-white transition duration-200 hover:scale-110 cursor-pointer via-indigo-700 to-blue-700 from-sky-700 bg-gradient-to-r  hover:border-[1px] hover:border-blue-400  border-[0.01px] border-gray-700 rounded-2xl shadow-2xl p-4 flex-col text-center items-center justify-center`}>
                            <div className='flex items-center justify-center mb-2 rounded-full'>
                                {
                                statics.icon.map(Icon => <div className=''>
                                    <Icon className='w-16 hover:transition hover:translate-y-1/4 duration-700 text-black h-16'
                                        key={index}/>
                                </div>)
                            } </div>
                            <div className=''>
