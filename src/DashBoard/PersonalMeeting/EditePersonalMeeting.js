...
const EditPersonalMeeting = () => {
  ...
  return (
    <div className="max-w-md pt-2">
      <button
        onClick={openModal}
        className="inline-flex items-center justify-center text-lg font-medium text-indigo-600 hover:text-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
      >
        <AiFillEdit size={20} />
      </button>
