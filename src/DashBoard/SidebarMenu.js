...
import { AiOutlineDashboard, AiOutlineForm, AiOutlineMail, AiOutlineHistory, AiOutlineSetting, AiOutlineUser } from 'react-icons/ai';
            ...
            <div className="flex lg:h-full h-1/2 flex-col  bg-gray-900 text-white">
                ...
                <nav className="flex-grow">
                    <ul className="flex flex-col">
                        <Link to="/profile/profileEdit" className="p-4 mt-4 hover:rounded-lg  hover:border-blue-700 hover:border-[0.5px] transition duration-300 hover:scale-110 hover:bg-gray-800">
